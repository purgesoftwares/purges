...
//			hide picker if click away
	...
	$(document).on('click', 'a.aq-sortable-add-new', function() {
		var action_id = $(this).attr('rel'),
			...
			$(this).text('');
			$(this).append('<span class="icon-cw"></span>');
	...
	$("#page_template").change(function() {
		if($(this).val() == 'templates/template-blog.php' || $(this).val() == 'template-sitemap.php' || $(this).val() == 'default' || $(this).val() == 'templates/template-portfolio.php') {
			$("#cf-custom-menu").show();
		} else {
			$("#cf-custom-menu").hide();
		}
	});
	if($("#page_template").val() == 'templates/template-blog.php' || $("#page_template").val() == 'template-sitemap.php' || $("#page_template").val() == 'default'  || $("#page_template").val() == 'templates/template-portfolio.php') {
		$("#cf-custom-menu").show();
	} else {
		$("#cf-custom-menu").hide();
	}
