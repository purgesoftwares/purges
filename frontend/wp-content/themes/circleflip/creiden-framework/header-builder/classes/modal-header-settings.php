...
<div class="modal fade hbModal" id="headerSettings" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			...
			<div class="modal-body">
				<div class="modalRow row clearfix">
					<div class="col-sm-7">
						...
						<span class="settingNote">For the small style, logo builder's style won't work.</span>
					</div>
					<div class="col-sm-5">
						<select>
