			...
			<div id="move-reply-<?php bbp_topic_id(); ?>" class="bbp-reply-move">
				...
				<form id="move_reply" name="move_reply" method="post" action="<?php the_permalink(); ?>">
					...
					<fieldset class="bbp-form">
						...
						<h2><?php printf( __( 'Move reply "%s"', 'bbpress' ), bbp_get_reply_title() ); ?></h2>
	
						<div>
	
							<div class="aq_alert bbpAlert info">
								<?php _e( 'You can either make this reply a new topic with a new title, or merge it into an existing topic.', 'bbpress' ); ?>
							</div>
	
							<div class="aq_alert bbpAlert note">
								<?php _e( 'If you choose an existing topic, replies will be ordered by the time and date they were created.', 'bbpress' ); ?>
							</div>
							...
							<fieldset class="bbp-form">
								<div class="moveReply">
									<div class="clearfix">
										...
										<label for="bbp_reply_move_option_reply"><p><?php printf( __( 'New topic in <strong>%s</strong> titled:', 'bbpress' ), bbp_get_forum_title( bbp_get_reply_forum_id( bbp_get_reply_id() ) ) ); ?></p></label>
									...
									<div class="clearfix">
										...
										<label for="bbp_reply_move_option_existing"><p><?php _e( 'Use an existing topic in this forum:', 'bbpress' ); ?></p></label>
							...
							<div class="bbp-submit-wrapper">
								<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_move_reply_submit" name="bbp_move_reply_submit" class="button btnStyle1 red withIcon submit"><div class="btnIcon icon-paper-plane"></div><span><?php _e( 'Submit', 'bbpress' ); ?></span><span class="btnBefore"></span><span class="btnAfter"></span></button>
							</div>
						</div>
