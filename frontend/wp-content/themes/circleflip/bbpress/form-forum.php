			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_forum_submit" name="bbp_forum_submit" class="button btnStyle1 red withIcon submit"><div class="btnIcon icon-paper-plane"></div><span><?php _e( 'Submit', 'bbpress' ); ?></span><span class="btnBefore"></span><span class="btnAfter"></span></button>
