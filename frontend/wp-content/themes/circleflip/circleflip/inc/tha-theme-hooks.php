...
function tha_header_top_left() {
	do_action( 'tha_header_top_left' );
}

function tha_header_top_right() {
	do_action( 'tha_header_top_right' );
}

function tha_header_ad_area() {
	do_action( 'tha_header_ad_area' );
}
