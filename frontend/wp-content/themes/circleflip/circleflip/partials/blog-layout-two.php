...
<div class="postBlog2 clearfix">
    <!-- Post Image -->
    <div class="postImage <?php echo has_post_format( 'video' ) ? 'embedBlock iframe_container' : '' ?>">
	<?php echo circleflip_get_post_format_media( $post->ID, 'blog_posts_2_full' ) ?>
    </div>
    <!-- Post Details -->
	...
	<div class="postCreagory clearfix">
	    <?php if ( cr_get_option( 'blog_author' ) == 1 ) { ?>
	...
	<a class="postLink btnStyle2 red" href="<?php the_permalink() ?>"><span><?php echo ($read_more_alt_text) ? $read_more_alt_text : _e( 'More', 'circleflip' ); ?></span><span class='btnBefore'></span><span class='btnAfter'></span></a>
    </div>
</div>
