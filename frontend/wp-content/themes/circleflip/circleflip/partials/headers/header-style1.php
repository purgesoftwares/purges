...
<?php if(cr_get_option('sticky_header') == 1){
 ...
 ?>
<header id="branding" role="banner" class="headerStyle1 mainHeader">
	<div class="container">
		<div id="menuContainer">
			...
			<?php if ( has_nav_menu( 'primary' ) || has_nav_menu('header-menu') ) : ?>
			...
			<div <?php circleflip_navbar_class(); ?> >
				<div class="navbar-inner" style="height: <?php echo esc_attr( cr_get_option( "header_height", '' ) ); ?>px;">
					...
					<div class="navCollapse">
						<?php
						switch (cr_get_option('top_area_header_settings','main_navigation')) {
