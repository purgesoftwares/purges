...
<header id="branding" role="banner" class="headerStyle4 mainHeader <?php if(cr_get_option('breaking_area') == 1){ echo 'headerStyle4Break'; } ?>" style="height: <?php echo cr_get_option("header_height",''); ?>px;">
	<div class="container clearfix">
		<div class="clearfix" id="menuContainer" style="height: <?php echo cr_get_option("header_height",''); ?>px;">
			...
			<div <?php circleflip_navbar_class_main(); ?>>
				<div class="navbar-inner" style="height: <?php echo cr_get_option("header_height",''); ?>px;">
