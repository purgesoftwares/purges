...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php edit_post_link( __( 'Edit', 'circleflip' ), '<footer class="entry-meta"><span class="edit-link label">', '</span></footer>' );
...
/* Location: ./wp-content/themes/circleflip/partials/content-page.php */